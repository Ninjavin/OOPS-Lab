public class FoodLineItem {
	...
	public void lunchTime() {
		if (this.item.getdesc().contains("Take Away") == false && this.item.getdesc().contains("Pizza") == false && this.item.getdesc().contains("Tea") == false && this.item.getdesc().contains("Coffee") == false	&& this.item.getdesc().contains("Cake") == false) {
			this.item.desc = this.item.desc + "(Lunch Time Special)";
		}
	}

	public void TeaTime() {
		if (this.item.getdesc().contains("Tea") || this.item.getdesc().contains("Coffee")	|| this.item.getdesc().contains("Cake")) {
